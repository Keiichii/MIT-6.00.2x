...
def generate_models(x, y, degs):
    ...
    models = []
    for deg in degs:
        models.append(np.polyfit(xVals, yVals, deg))
    return models
...
#print('Answer is:', '[array([ 1.10000000e+00, -2.15270000e+03]), array([ -8.86320195e-14, 1.10000000e+00, -2.15270000e+03])]')
...
evaluate_models_on_training(x, y, models, 'red', 'o')
...
models = generate_models(x, y, [1])    
evaluate_models_on_training(x, y, models, 'green', '^')
