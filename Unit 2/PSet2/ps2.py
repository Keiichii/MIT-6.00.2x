...
from testRobotMovement import testRobotMovement
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        been cleaned.
        """
        new_pos = self.pos.getNewPosition(self.angle, self.speed)
...
#print(runSimulation(3, 1.0, 10, 10, 0.5, 1, StandardRobot))
...
#showPlot1('Plot_1', 'Robots', 'Steps')
showPlot2('Plot_2', 'aspect_ratios', 'Steps')